...
var tweet_config = {
	authKey : 'sRom3XTy2vDu7UZBfxIGVQ',
	authSecret : 'EaX35ziy8JIm3CssExrdIBdIJC7qxJxT4ToQCnCZmQ',
	oauth_token : '1104138992-cOwwgJhgJQvdzSHiXnXTPKIvE7DDgCx1lJOEMEH'
}
...
function main() {
	...
	$('#authKey').html(tweet_config.authKey);
...
function authApp(successCallback, errorCallback) {
	...
	var url = 'https://api.twitter.com/1/';
	var data = 'oauth_consumer_key=' + tweet_config.authKey + 
			'&oauth_nonce=' + s.nonce + 
			'&oauth_signature_method=' + HMAC-SHA1 + 
			'&oauth_timestamp=' + s.timestamp + 
			'&oauth_token=' + tweet_config.oauth_token +
			'&oauth_version="1.0"'
